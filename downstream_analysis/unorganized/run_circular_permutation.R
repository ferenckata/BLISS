...
pt2 <- permTest(A=abed, B=bbed, ntimes=1000, alternative="auto", verbose=FALSE, genome=hg19_masked,
                evaluate.function=numOverlaps, randomize.function=circularRandomizeRegions, force.parallel=NULL,
                mc.cores=4, count.once=FALSE, mc.set.seed=FALSE) # mc.se.seed=FALSE needs to be set for reproducing
